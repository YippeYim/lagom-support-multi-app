...
ยินดีต้อนรับสู่โปรเจกต์กลุ่ Web App PhotoBooth! เอกสารฉบับนี้จัดทำขึ้นเพื่อให้ทีมงานทั้ง 5 คนเข้าใจโครงสร้างโปรเจกต์และวิธีการทำงานร่วมกันโดยใช้ Git ให้ราบรื่นที่สุด
